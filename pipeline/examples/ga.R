...
results <- process.using_GA(dataframe, gene_pool_size=30, seed=3, weights=c(1,1,1,1), fitness_mode="sum", with_statistics=TRUE)

#data output functions
output.dataframe_to_file(results$statistics, "GAreport.csv")
